package woowa.tream4.bff.api.client.caller;
...
import woowa.tream4.bff.api.client.config.SearchClientConfiguration;
import woowa.tream4.bff.api.client.request.SearchRequest;
import woowa.tream4.bff.api.client.response.SearchResponse;
...
public class SearchApiCaller {
    ...
    public List<SearchResponse> send(SearchRequest SearchRequest) {
